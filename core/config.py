...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_auto_close_response": "Diese Anfrage wurde aufgrund von keiner Aktivität geschlossen: {timeout}.",
        "thread_creation_response": "Deine Anfrage wurde an unser Team weitergeleitet.",
        "thread_creation_footer": "Deine Nachricht wurde versandt.",
        "thread_self_closable_creation_footer": "Klicke auf das Schloss, um die Anfrage zu schließen.",
        "thread_creation_title": "Anfrage erstellt",
        "thread_close_footer": "Das Antworten führt zu einer neu erstellten Anfrage",
        "thread_close_title": "Anfrage geschlossen",
        "thread_close_response": "{closer.mention} hat diese Anfrage geschlossen.",
        "thread_self_close_response": "Du hast diese Anfrage geschlossen.",
        "thread_move_notify": False,
        "thread_move_response": "Diese Anfrage wurde entfernt.",
        "disabled_new_thread_title": "Nicht versandt",
        "disabled_new_thread_response": "Wir nehmen zurzeit keine neuen Anfragen an.",
        "disabled_new_thread_footer": "Bitte versuche es später noch einmal...",
        "disabled_current_thread_title": "Nicht versandt",
        "disabled_current_thread_response": "Wir nehmen zurzeit keine neuen Anfragen an.",
